  ...
  <body>
    ...
    <header class="header">
      <div class="header-content animated flash">
        <img src="img/logo.png" alt="Falcon Logo" class="logo">
        <div class="title">
          Falcón site Page
        </div>
        <div class="text">
          Dolor est eos dignissimos eos eos reiciendis deleniti neque quisquam. Officia facere pariatur consequuntur soluta!
        </div>
    ...
    <section class="about bg-light">
      <div class="container text-center">
        <div class="grid-2">
          ...
          <div>
            <h3 class="title">Progamming Courses</h3>
            <p>
    ...
    <footer class="text-center bg-light">
      <p>Falcon Web &copy; 2021 - All rights reserved</p>
    </footer>
